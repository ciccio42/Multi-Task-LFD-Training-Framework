    ...
    for S in 89; do #81000 89100; do
        for TASK in pick_place; do
            for COUNT in 1; do
                ...
                srun --output=test_${PROJECT_NAME}.txt --job-name=test_${PROJECT_NAME} python $BASE_PATH/repo/Multi-Task-LFD-Training-Framework/test/multi_task_test/test_real_world_dataset.py  $MODEL \
                                            --env $TASK \
                                            --saved_step $S \
                                            --eval_each_task 1 \
