...
FINETUNE = False
RESUME = False
PROJECT_NAME = "Real-1Task-pick_place-Simulated-Agent-Human-Demonstration-UR5e-Agent-MOSAIC-COD-SKIP-0-5-10-15-FixedDetector-WristImg"
...
DEMO_NAME = 'human_rgb'
MAX_EPOCHS = 1000
# real_eye_in_hand_ur5e dataset trajectories carry 'eye_in_hand_image' per
# frame (verified present in the raw pkls), and MultiTaskPairedDataset (the
# dataset class config_real.yaml actually uses for this script) exposes it
# as ret_dict['wrist_images'] -- unlike the detector's own dataset class,
# which discards it as `_wrist_images`. So USE_WRIST_IMG=True is safe here.
AGENT_NAME = 'real_eye_in_hand_ur5e'  # [real_eye_in_hand_ur5e or real_new_ur5e]
USE_WRIST_IMG = True  # True if using eye-in-hand camera, False if using front camera
