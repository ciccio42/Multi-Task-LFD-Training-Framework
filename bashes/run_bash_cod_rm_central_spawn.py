...
# Auto-resubmitting orchestrator for train_cond_target_obj_detector_rm_central_spawn.sh - duplicate of
# run_bash_cod_removed_spawn_regions.py, see that script's own docstring for the resume-mechanics
# background (unchanged here).
BASH_SCRIPT = "/mnt/beegfs/frosa/Multi-Task-LFD-Framework/repo/Multi-Task-LFD-Training-Framework/bashes/train_cond_target_obj_detector_rm_central_spawn.sh"
...
RESUME_PATH = "/mnt/beegfs/frosa/checkpoint_save_folder/checkpoint_save_folder/spawn_region_experiments/1Task-pick_place-COD_rm_central_spawn-Batch80"
RESUME_STEP = 16
RESUME = True
