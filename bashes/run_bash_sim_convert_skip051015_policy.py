...
# convention) and tasks_cfgs=7_tasks_sim_skip_0_5_10_15 (holds out subtasks
# 0/5/10/15, matching the real-world policy's split, instead of the other
# sim-convert run's 12/13/14/15) -- see
# train_mosaic_target_obj_detector_double_policy_convert_skip051015.sh and
# tasks_cfgs/7_tasks_sim_skip_0_5_10_15.yaml. Fresh start: this EXP_NAME/
# checkpoint folder doesn't exist yet, so RESUME_FOLDER/STEP on the first
# submission are unused (FINETUNE=False, RESUME=False).
#
...
BASH_SCRIPT = "/mnt/beegfs/frosa/Multi-Task-LFD-Framework/repo/Multi-Task-LFD-Training-Framework/bashes/train_mosaic_target_obj_detector_double_policy_convert_skip051015.sh"
...
PROJECT_NAME = "1Task-pick_place-Simulated-Agent-Human-Demonstration-UR5e-Agent-MOSAIC-COD-SKIP-0-5-10-15-ConvertAction"
