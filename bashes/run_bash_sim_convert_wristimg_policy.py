...
# convention) AND use_wrist_img=true, meant as a sim baseline for a future
# sim-to-real finetune on the real eye-in-hand data. The sim ur5e_pick_place
# dataset didn't carry eye_in_hand_image before -- see
# add_eye_in_hand_sim_dataset.py, which extended opt_dataset/ur5e_pick_place
# with it from the raw no_opt_dataset trajectories. Fresh start: this
# EXP_NAME/checkpoint folder doesn't exist yet, so RESUME_FOLDER/STEP on
# the first submission are unused (FINETUNE=False, RESUME=False).
BASH_SCRIPT = "/mnt/beegfs/frosa/Multi-Task-LFD-Framework/repo/Multi-Task-LFD-Training-Framework/bashes/train_mosaic_target_obj_detector_double_policy_convert_wristimg.sh"
...
# ...-COD-SKIP-12-13-14-15-Batch60` (relative to SAVE_PATH), which only
...
PROJECT_NAME = "1Task-pick_place-Simulated-Agent-Human-Demonstration-UR5e-Agent-MOSAIC-COD-SKIP-12-13-14-15-ConvertAction-WristImg"
