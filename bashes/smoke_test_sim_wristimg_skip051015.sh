...
USE_WRIST_IMG="${8:-true}" # [true or false] True if using eye-in-hand camera
...
echo "Use Wrist Img is: $USE_WRIST_IMG"
...
if [ "$TASK_NAME" == 'nut_assembly' ]; then
    ...
    EXP_NAME=1Task-pick_place-Simulated-Agent-Human-Demonstration-UR5e-Agent-MOSAIC-COD-SKIP-0-5-10-15-ConvertAction-WristImg
    PROJECT_NAME=${EXP_NAME}
...
srun --output=smoke_test_sim_wristimg_skip051015.txt --job-name=smoke_test_sim_wristimg python -u ../training/train_scripts/train_any.py \
