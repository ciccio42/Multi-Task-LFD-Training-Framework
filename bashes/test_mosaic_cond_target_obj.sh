...
if [ "$TASK_NAME" == 'pick_place' ]; then
    ...
    PROJECT_NAME=1Task-pick_place-Simulated-Agent-Human-Demonstration-UR5e-Agent-MOSAIC-COD-SKIP-12-13-14-15
    #1Task-pick_place-Simulated-Agent-Human-Demonstration-UR5e-Agent-MOSAIC-COD-SKIP-12-13-14-15
    #1Task-pick_place-Simulated-Agent-Human-Demonstration-UR5e-Agent-COD-SKIP-12-13-14-15
