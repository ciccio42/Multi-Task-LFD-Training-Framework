...
# ur5e_pick_place_rm_one_spawn/ (see that dir's new_trj_removed_spawn_regions.json, and
...
#SBATCH --export=ALL
#SBATCH --job-name=cod_rm_one_spawn
#SBATCH --output=slurm_cod_rm_one_spawn_%j.out
