...
DATASET_PATH="/user/frosa/multi_task_lfd/datasets/datasets_delta/real_ur5e_rgb_pick_place_delta" # "/user/frosa/multi_task_lfd/datasets/datasets_delta/sim_ur5e_pick_place_delta"
NUMBER_OF_BINS=256
