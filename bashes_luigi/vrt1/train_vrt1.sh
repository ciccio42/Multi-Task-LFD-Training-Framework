...
COUPLE_PATHS_JSON='/raid/home/frosa_Loc/Multi-Task-LFD-Framework/repo/Multi-Task-LFD-Training-Framework/bashes_luigi/training_json/only_task_09'
...
# ASK_str=[asu_table_top_delta,berkeley_autolab_ur5_delta,iamlab_cmu_pickup_insert_delta,taco_play_delta,sim_panda_pick_place_converted_delta]
...
# EXP_NAME="RT1-From-Scratch-Simulated-Only-Human-${HEIGHT}x${WIDTH}-One-Task-And-One-Demonstration-Subsampled-1cm-Last-Frame-With-Open-Gripper"
# EXP_NAME="RT1-Pretraining-Ur5e-Panda-${HEIGHT}x${WIDTH}"
EXP_NAME="RT1-From-Scratch-Sim-UR5e-Only-Task-09-times-10"
...
python -u ../../training/train_scripts/train_any.py \
    ...
    dataset_cfg.max_demo_for_variation=${MAX_DEMO_FOR_VARIATION} \
