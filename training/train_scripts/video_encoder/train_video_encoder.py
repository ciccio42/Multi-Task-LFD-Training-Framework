...
def main(cfg):
    ...
    all_tasks_cfgs = [cfg[''][''][''].tasks_cfgs.nut_assembly, 
                      cfg[''][''][''].tasks_cfgs.door, 
                      cfg[''][''][''].tasks_cfgs.drawer,
                      cfg[''][''][''].tasks_cfgs.button, 
                      cfg[''][''][''].tasks_cfgs.pick_place, 
                      cfg[''][''][''].tasks_cfgs.stack_block, 
                      cfg[''][''][''].tasks_cfgs.basketball]
